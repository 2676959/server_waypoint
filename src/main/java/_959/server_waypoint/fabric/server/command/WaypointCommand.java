package _959.server_waypoint.fabric.server.command;
...
import _959.server_waypoint.fabric.util.TextButton;
...
import static _959.server_waypoint.fabric.server.command.suggestion.SuggestionProviders.*;
...
import static _959.server_waypoint.fabric.server.WaypointServer.CONFIG;
import static _959.server_waypoint.fabric.util.TextHelper.*;
import static _959.server_waypoint.fabric.util.TextHelper.DimensionColorHelper.getDimensionColor;
import static _959.server_waypoint.fabric.network.payload.s2c.WaypointModificationS2CPayload.ModificationType;
import static _959.server_waypoint.fabric.util.SimpleWaypointHelper.DEFAULT_STYLE;
import static _959.server_waypoint.fabric.util.SimpleWaypointHelper.simpleWaypointToFormattedText;
import static _959.server_waypoint.fabric.util.CommandGenerator.tpCmd;
