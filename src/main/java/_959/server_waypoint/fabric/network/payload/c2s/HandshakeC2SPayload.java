package _959.server_waypoint.fabric.network.payload.c2s;
...
public record HandshakeC2SPayload(int waypointsEdition) implements CustomPayload {
    public static final Identifier HANDSHAKE_PAYLOAD_ID = Identifier.of(ServerWaypointFabric.MOD_ID, "handshake");
