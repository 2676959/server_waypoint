# Historical NKpsk0 dependency investigation

Archived when the KK evaluation completed on 2026-09-06. The decision and reopening requirements
below apply to the former NKpsk0 requirement, not the current KK selection.
See the [current decision](cross-server-noise-dependency-decision.md).
