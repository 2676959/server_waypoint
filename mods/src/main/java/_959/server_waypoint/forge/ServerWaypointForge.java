...
*///?} else {
    ...
    public ServerWaypointForge() {
        ...
        this.c2sPacketHandler = new C2SPacketHandler<>(messageSender, this.waypointServer, uploadCoordinator);
    ...
    private void registerPayloads() {
        if (FMLEnvironment.dist == Dist.CLIENT) {
            ...
            //? if >= 1.20.5 {
            registerS2C(UploadRequestS2CPayload.class, 9, UploadRequestS2CPayload.PACKET_CODEC, (payload, context) -> {});
            //?}
        }
...
*///?} else {
        ...
        //? if >= 1.20.5 {
        registerC2S(UploadChunkC2SPayload.class, 10, UploadChunkC2SPayload.PACKET_CODEC, (payload, context) -> {
            ServerPlayer player = context.getSender();
            if (player != null) {
