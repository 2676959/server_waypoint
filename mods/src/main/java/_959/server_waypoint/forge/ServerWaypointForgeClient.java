...
public class ServerWaypointForgeClient {
    ...
    public static void registerClientPayloadHandlers() {
        ...
        registerClientPayload(WaypointListS2CPayload.class, 0, WaypointListS2CPayload::new, waypointListHandler);
        registerClientPayload(DimensionWaypointS2CPayload.class, 1, DimensionWaypointS2CPayload::new, dimensionWaypointHandler);
        registerClientPayload(WorldWaypointS2CPayload.class, 2, WorldWaypointS2CPayload::new, worldWaypointHandler);
        registerClientPayload(WaypointModificationS2CPayload.class, 3, WaypointModificationS2CPayload::new, waypointModificationHandler);
        registerClientPayload(UpdatesBundleS2CPayload.class, 4, UpdatesBundleS2CPayload::new, updatesBundleHandler);
        registerClientPayload(ServerHandshakeS2CPayload.class, 5, ServerHandshakeS2CPayload::new, serverHandshakeHandler);
    }
